...
public class VideoSeeder {
	...
	public void seedVideos(){
		...
		mapVideos.put("XbGs_qK2PQA", "Eminem - Rap God (Explicit)");
		...
		mapVideos.put("O74TAJNR9Sw", "Gatos Graciosos - Videos de Risa de Gatos Chistosos #22");
		...
		for(String video_code:mapVideos.keySet()) {
			...
			List<Etiqueta> etiquetas = EtiquetaSeeder.getInstance().getSomeEtiquetas();
